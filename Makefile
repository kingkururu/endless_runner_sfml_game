...
CXX = clang++  
CXXFLAGS = -std=c++17 -Wall -I./src -I./src/game/constants -I./src/game -I./src/game/physics/collisions -I./src/game/physics -I./src/assets/sprites -I./src/assets/fonts -I./src/assets/sound
...
SRC = src/main.cpp \
      ...
      src/game/game.cpp \
      src/game/physics/collisions/collisions.cpp \
