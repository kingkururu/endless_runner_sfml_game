...
CXX = clang++  
CXXFLAGS = -std=c++17 -Wall -I./src -I./src/game/global -I./src/game/constants -I./src/game -I./src/assets/sprites -I./src/assets/fonts -I./src/assets/sound
LDFLAGS = -L/opt/homebrew/lib -lsfml-graphics -lsfml-window -lsfml-system -lsfml-audio

# Source files and target
SRC = src/main.cpp \
      src/game/global/global.cpp \
